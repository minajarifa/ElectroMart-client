                    ...
                    <tr key={userOne?._id}>
                        ...
                        <div className="inline-flex items-center gap-x-3">
                          ...
                          <div className="flex items-center gap-x-2">
                            <img
                              ...
                              src={userOne.photo||`https://i.ibb.co.com/mrK7Sjcw/download.png`}
                              alt=""
                            />
                            <div>
                      ...
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        <div className="flex items-center gap-x-6">
                            {/* user Deleted button */}
                          <button onClick={()=>handleDeleteButton(userOne?._id)} className="text-xl text-red-500 hover:text-red-800">
                           <RiDeleteBin6Fill />
                          </button>
